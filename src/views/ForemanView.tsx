      ...
      {activeTab === 'dashboard' && (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-white rounded-2xl border border-slate-200 p-5 shadow-xs">
            <h2 className="text-base font-bold text-slate-900 mb-1">Daftar SPK Menunggu & On Progress</h2>
            <p className="text-xs text-slate-500 mb-4">Foreman review pekerjaan dan tugaskan mekanik</p>
