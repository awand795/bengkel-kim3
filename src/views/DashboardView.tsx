      ...
      <div className="space-y-6">
          ...
          <div className="relative z-10">
            ...
            <div className="mt-4 flex flex-wrap gap-2.5">
              <button
                ...
                className="px-3 py-1.5 rounded-md bg-surface-raised text-ink font-bold text-xs shadow-sm hover:bg-surface transition-all flex items-center gap-1.5 cursor-pointer"
              >
                <ClipboardList className="w-3.5 h-3.5" /> + Penerimaan &amp; Buat SPK
              </button>
              <button
                onClick={() => setActiveTab('sa-list')}
                className="px-3 py-1.5 rounded-md bg-ink/40 hover:bg-ink/60 text-white font-semibold text-xs border border-white/20 transition-all flex items-center gap-1.5 cursor-pointer"
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-surface-raised rounded-md border border-border p-5 shadow-xs flex flex-col justify-between">
            ...
            <button
              onClick={() => setActiveTab('sa-kotak-merah')}
              className="w-full mt-4 py-2 px-3 rounded-md bg-status-red text-white font-bold text-xs hover:bg-status-red/90 transition-colors shadow-xs flex items-center justify-center gap-2 cursor-pointer"
            >
